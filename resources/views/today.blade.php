...
<div class="container">
    ...
    <div class="row row-cols-3 g-5">
        ...
        <div class="col card">
            <div class="card-body">
                <h5 class="card-title">Stazione partenza: <span
                        class="card-text">{{ $train -> {'Stazione di partenza'} }}</span></h5>
                <h5 class="card-title">Stazione di arrivo: <span
                        class="card-text">{{ $train -> {'Stazione di arrivo'} }}</span></h5>
            </div>
